...
export default memo(
  /**
   * Individual photo tile in a grid view.
   *
   * Renders a blurhash canvas placeholder that fades out once the thumbnail loads.
   * Supports drag-to-desktop, selection (checkbox, shift-click range, ctrl-click toggle),
   * and a right-click context menu with admin trash action.
   *
