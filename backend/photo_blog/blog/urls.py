...
from .views import (
    ...
    PhotoDownloadView,
    PhotoListView,
    PhotoCategoryPatchView,
    PhotoGeotagPatchView,
    PhotoUploadView,
    ReportPhotoView,
    TrashEmptyView,
    TrashPurgeView,
...
urlpatterns = [
    ...
    path('photos/<slug:slug>/patch/', PhotoCategoryPatchView.as_view(), name='photo-patch'),
    path('photos/<slug:slug>/geotag/', PhotoGeotagPatchView.as_view(), name='photo-geotag'),
    path('photos/upload/', PhotoUploadView.as_view(), name='photo-upload'),
    path('photos/download/', PhotoDownloadView.as_view(), name='photo-download'),
